...
model_path = "./data/sherlock-language-model " + network_type \
...
def calc_loss(number_training_examples=1000):
    ...
    print("Actual loss: %f" % model.calculate_loss(x_train[:number_training_examples], y_train[:number_training_examples]))
